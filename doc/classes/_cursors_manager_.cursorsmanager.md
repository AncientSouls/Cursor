[ancient-cursor](../README.md) > ["cursors-manager"](../modules/_cursors_manager_.md) > [CursorsManager](../classes/_cursors_manager_.cursorsmanager.md)
...
* [constructor](_cursors_manager_.cursorsmanager.md#constructor)


### Properties

* [Node](_cursors_manager_.cursorsmanager.md#node)
* [destroy](_cursors_manager_.cursorsmanager.md#destroy)
* [emitter](_cursors_manager_.cursorsmanager.md#emitter)
* [generateId](_cursors_manager_.cursorsmanager.md#generateid)
* [id](_cursors_manager_.cursorsmanager.md#id)
* [isDestroyed](_cursors_manager_.cursorsmanager.md#isdestroyed)
* [nodes](_cursors_manager_.cursorsmanager.md#nodes)


### Methods

* [add](_cursors_manager_.cursorsmanager.md#add)
* [create](_cursors_manager_.cursorsmanager.md#create)
* [emit](_cursors_manager_.cursorsmanager.md#emit)
* [off](_cursors_manager_.cursorsmanager.md#off)
* [on](_cursors_manager_.cursorsmanager.md#on)
* [once](_cursors_manager_.cursorsmanager.md#once)
* [remove](_cursors_manager_.cursorsmanager.md#remove)
* [wrap](_cursors_manager_.cursorsmanager.md#wrap)
...
### ⊕ **new CursorsManager**(id?: *`string`*): `any`
