[ancient-cursor](../README.md) > ["childs-cursors-manager"](../modules/_childs_cursors_manager_.md) > [IChildsCursorsManager](../interfaces/_childs_cursors_manager_.ichildscursorsmanager.md)
...
#### IEventsList :  [ICursorsManagerEventsList](_cursors_manager_.icursorsmanagereventslist.md)
## Hierarchy


↳  [ICursorsManager](_cursors_manager_.icursorsmanager.md)`IN`, `IEventsList`
...
► **maintain**(path: *`string`*): [ICursorEventListener](_cursor_.icursoreventlistener.md)
...
**Returns:** [ICursorEventListener](_cursor_.icursoreventlistener.md)
